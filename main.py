import random    #this labrary is used to select a random value from the given values
import tkinter   #tkinter is a standard GUI library for python .Twinkter is used to make the GUI in python
